...
function checkId() {
	...
	if (id == "") {
		...
		window.open("/mvcMember/member/checkId.do?id="+id,"","width=400 height=200")// 새로운
															// 창을
															// 띄우게 함
	}
}
...
opener.document.writeForm.id.value = id; // 열려있는창의 id 자리에 id값을 넣기
	opener.document.writeForm.idDuplicationCheck.value = id;
...
function checkPost() {
	window.open("/mvcMember/member/checkPost.do", "", "width=600 height=500 scrollbars=yes");
}
